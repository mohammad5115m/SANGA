...
4. ثبت توافق معامله تلفنی/حضوری توسط خریدار یا فروشنده
5. تأیید دوطرفه، معامله نهایی و فاکتور
...
apps/
  ...
  trading/      توافق دوطرفه و معامله نهایی (چندردیفی)
...
- پیشنهاد معامله تا تأیید طرف مقابل هیچ اثر مالی ندارد.
- تأیید دوطرفه یک معامله، دو سند دفتر و یک فاکتور صادرشده می‌سازد.
